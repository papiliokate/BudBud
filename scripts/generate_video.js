...
async function main() {
    ...
    const ttsPools = {
        standard: [
            "Can you match all the friends in Bud Bud? Check out the link in our bio to play all our games for free!",
            "Here is today's Bud Bud puzzle. Find the connections, and head to our profile to play for free!",
            "Let's see if you can solve this friendship sequence. Give it a try at the link in our bio!"
        ],
        fail: [
            "This puzzle is genuinely so difficult. Even the bot is struggling! Think you can do better? Try it at the link in our bio!",
            "I can't believe the AI made a mutual dislike connection! Can you solve it? Link in bio to play.",
            "Wow, this one is tough. Even the computer couldn't get it. Prove you're better via our profile link!"
        ],
        interactive: [
            "Only 1% of players memorize the board well enough to find this final match. What connects them? Play for free via the link in our profile!",
            "Which bud is the winning match? Let us know in the comments and play at the link in our bio!",
            "Can you spot the final connection? Test your logic for free via the link in our profile."
        ]
    };
